...
namespace GaoJD.Club.Core
{
    ...
    public class LogicBase<TEntity> : ILogicBase<TEntity> where TEntity : class
    {
        ...
        {
            return _dalBase.Insert(entity, autoSave);
        }
        ...
        {
            return _dalBase.Update(entity, autoSave);
        }
        ...
        {
            _dalBase.Delete(entity, autoSave);
        }
        ...
        public void Delete(Expression<Func<TEntity, bool>> where, bool autoSave = true)
        {
            ...
            _dalBase.Delete(where, autoSave);
        }
